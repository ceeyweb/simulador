class CreateUsers < ActiveRecord::Migration[5.2]
  def change
    create_table :users do |t|
      ...
      t.boolean :en_hogar_habia_celular
      t.boolean :en_hogar_habia_telefono_fijo
      t.boolean :en_hogar_habia_internet
      t.boolean :en_hogar_habia_estufa
      t.boolean :en_hogar_habia_refri
      t.boolean :en_hogar_habia_calentador
      t.boolean :en_hogar_habia_tostador
      t.boolean :en_hogar_habia_agua
      t.boolean :en_hogar_habia_bano
      t.boolean :en_hogar_habia_electricidad
