class QuestionsAdapter
  ...
  DATA = {
    institution_id: "¿Alguna institución educativa te recomendó o pidió contestar el Simulador de Movilidad Social? Selecciona o escribe el nombre de la institución.",
    age: "¿Cuál es tu edad?",
